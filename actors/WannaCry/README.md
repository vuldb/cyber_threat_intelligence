...
2 | File | `/admin/usermanagement.php` | High
3 | File | `/bcms/admin/?page=reports/daily_court_rental_report` | High
4 | File | `/cgi-bin/pass` | High
5 | File | `/ctpms/admin/?page=applications/view_application` | High
6 | File | `/dev/tcx0` | Medium
7 | File | `/dev/urandom` | Medium
8 | File | `/etc/environment` | High
9 | File | `/etc/passwd` | Medium
10 | File | `/home.jsp` | Medium
11 | File | `/spip/ecrire/` | High
12 | File | `/student-grading-system/rms.php?page=school_year` | High
13 | File | `/tmp` | Low
