# Roma225 - Cyber Threat Intelligence
...
34 | File | `/remote/put_file` | High
35 | File | `/setting/NTPSyncWithHost` | High
36 | File | `/spip.php` | Medium
37 | File | `/squashfs-root/etc_ro/custom.conf` | High
38 | File | `/src/c-blosc2/plugins/codecs/ndlz/ndlz4x4.c` | High
39 | ... | ... | ...
