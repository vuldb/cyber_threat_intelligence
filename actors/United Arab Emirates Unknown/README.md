...
25 | File | `/proc/ftxxxx-debug` | High
26 | File | `/proxy` | Low
...
46 | File | `admin/admin_editor.php` | High
47 | File | `admin/asset/grid-proxy` | High
48 | File | `admin/auditTrail.jsf` | High
49 | File | `admin/conf_users_edit.php` | High
50 | File | `admin/data.php` | High
