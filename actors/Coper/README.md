...
14 | File | `/app/system/column/admin/index.class.php` | High
...
34 | File | `/inc/lists/edit-list.php` | High
35 | File | `/inc/lists/view-list.php` | High
...
41 | File | `/intern/controller.php` | High
