...
2 | File | `/add-pig.php` | Medium
3 | File | `/admin.php?p=/Area/index#tab=t2` | High
4 | File | `/admin/AdminLogin.php` | High
...
19 | File | `/admin/search-report-details.php` | High
...
42 | File | `/control/login.php` | High
43 | File | `/course/modedit.php` | High
44 | File | `/create-id-card` | High
