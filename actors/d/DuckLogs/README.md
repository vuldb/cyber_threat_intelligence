...
21 | File | `/admin/tags/save` | High
22 | File | `/admin/twitter.php` | High
23 | File | `/admin/userprofile.php` | High
24 | File | `/admin/yesterday-reg-users.php` | High
...
46 | File | `/Controls/Generic/EBMK/Handlers/EStatements/DownloadEStatement.ashx` | High
47 | File | `/customnode/install` | High
48 | File | `/dcim/rack-roles/` | High
