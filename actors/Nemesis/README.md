# Nemesis - Cyber Threat Intelligence
...
These _countries_ are directly (e.g. origin of attacks) or indirectly (e.g. access by proxy) associated with Nemesis:
...
_Tactics, techniques, and procedures_ (TTP) summarize the suspected MITRE ATT&CK techniques used by _Nemesis_. This data is unique as it uses our predictive model for actor profiling.
