...
8 | File | `/DS/LM_API/api/ConfigurationService/GetImages` | High
9 | File | `/DS/LM_API/api/SelectionService/GetPaggedTab` | High
10 | File | `/DS/LM_API/api/SelectionService/InsertQueryWithActiveRelationsReturnId` | High
11 | File | `/edit-computer-detail.php` | High
12 | File | `/etc/sudoers` | Medium
13 | File | `/goform/formSetEmail` | High
14 | File | `/goform/SetSpeedWan` | High
15 | File | `/LMS/LM/#main` | High
16 | File | `/mhds/clinic/view_details.php` | High
17 | File | `/modules/atari-img.c` | High
18 | File | `/modules/projects/vw_files.php` | High
19 | File | `/password/reset` | High
