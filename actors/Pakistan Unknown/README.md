...
16 | File | `/inc/topBarNav.php` | High
...
21 | File | `/send_order.cgi?parameter=access_detect` | High
22 | File | `/spip.php` | Medium
23 | File | `/text/pdf/PdfReader.java` | High
...
34 | File | `admin/?page=students/view_student` | High
35 | ... | ... | ...
