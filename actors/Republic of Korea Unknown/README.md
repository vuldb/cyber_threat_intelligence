...
20 | File | `/authUserAction!edit.action` | High
21 | File | `/backup.pl` | Medium
22 | File | `/bin/httpd` | Medium
23 | File | `/browse.PROJECTKEY` | High
...
30 | File | `/cmscp/ext/collect/fetch_url.do` | High
