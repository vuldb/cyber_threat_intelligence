...
9 | File | `/admin/all-request.php` | High
...
41 | File | `/api/wizard/getNetworkConf` | High
42 | File | `/api/wizard/networkSetup` | High
...
50 | File | `/cgi-bin/mainfunction.cgi` | High
51 | ... | ... | ...
