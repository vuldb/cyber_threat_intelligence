...
14 | File | `/index.php?route=extension/shiprocket/module/restapi` | High
15 | File | `/librarian/bookdetails.php` | High
16 | File | `/messageboard/view.php` | High
17 | File | `/mobile_seal/get_seal.php` | High
18 | File | `/new` | Low
...
25 | File | `/vicidial/AST_agent_time_sheet.php` | High
...
38 | File | `admin/systemOutOfBand.do` | High
39 | File | `adminAvatars.php` | High
40 | File | `adminBackupdatabase.php` | High
41 | File | `adminForums.php` | High
