...
3 | File | `/admin/all-requests.php` | High
4 | File | `/admin/content/index` | High
5 | File | `/admin/edit_categories.php` | High
6 | File | `/admin/makehtml_freelist_action.php` | High
7 | File | `/admin/member_save.php` | High
8 | File | `/admin/new-requests.php` | High
9 | File | `/admin/robot/approval/list` | High
10 | File | `/admin/sales/manage_sale.php` | High
11 | File | `/api/mjkj-chat/chat/ai/delete/chat` | High
12 | File | `/api/v1.index.article/getList.html` | High
13 | File | `/blog` | Low
