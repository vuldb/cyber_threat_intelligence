...
28 | File | `/include/commrecc.inc.php` | High
...
40 | File | `/system-info/health` | High
...
52 | File | `admin/index.php/user/del/1` | High
53 | File | `admin/index.php?id=themes&action=edit_chunk` | High
54 | File | `admin/loginform.php` | High
55 | File | `admin/products/controller.php?action=add` | High
56 | File | `admin/systempreferences.pl` | High
57 | ... | ... | ...
