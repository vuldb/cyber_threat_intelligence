...
-- | --------- | -------- | ----------- | ----------
1 | T1006 | CWE-22, CWE-23, CWE-24, CWE-40 | Path Traversal | High
...
6 | File | `/activity/newActivityedit.php?DontCheckLogin=1&id=null&ret=mod1` | High
7 | File | `/add-office.php` | High
8 | File | `/add_job` | Medium
9 | File | `/adm/index.php` | High
10 | File | `/admin-cp/log-viewer` | High
11 | File | `/admin-cp/setting/system/general` | High
...
20 | File | `/admin/add_visitor.php` | High
21 | File | `/admin/admin-area.php` | High
22 | File | `/admin/adminScoreUrl` | High
23 | File | `/admin/admin_addnew_product.php` | High
24 | File | `/admin/ajax.php?action=save_student` | High
25 | File | `/admin/app/web_crud.php` | High
26 | File | `/admin/assets/plugins/DataTables/media/unit_testing/templates/js_data.php` | High
27 | File | `/admin/assign_save.php` | High
28 | File | `/admin/category.php` | High
29 | File | `/admin/changeimage4.php` | High
30 | File | `/admin/class.php?dowhat=modifyclass` | High
31 | File | `/admin/clientview.php` | High
32 | File | `/admin/conferences/list/` | High
33 | File | `/admin/config_MT.php?action=delete` | High
34 | File | `/admin/contactus.php` | High
35 | File | `/admin/create_product.php` | High
36 | File | `/admin/delete-user.php` | High
37 | File | `/admin/delete_member.php` | High
38 | File | `/admin/div_data/delete?divId=9` | High
39 | File | `/admin/edit-art-product-detail.php?editid=2` | High
40 | File | `/admin/edit-customer-detailed.php` | High
41 | File | `/admin/edit-services.php` | High
42 | File | `/admin/edit-subadmin.php` | High
43 | File | `/admin/edit-user.php` | High
44 | File | `/admin/edit.php` | High
45 | File | `/admin/edit_manufacturer.php` | High
46 | File | `/admin/edit_teacher.php` | High
...
51 | File | `/admin/group/edit.do` | High
52 | File | `/admin/index.php` | High
53 | File | `/admin/login.php` | High
54 | File | `/admin/manage-outgoingvehicle.php` | High
55 | File | `/admin/manage-services.php` | High
56 | File | `/admin/manage_seat.php` | High
57 | File | `/admin/media_folders` | High
58 | File | `/admin/member_save.php` | High
59 | File | `/admin/menu/toEdit` | High
60 | File | `/admin/modules/subject/edit.php` | High
...
65 | File | `/admin/orders/update_status.php` | High
66 | File | `/admin/pass-bwdates-reports-details.php` | High
67 | File | `/admin/positions.php` | High
68 | File | `/admin/product-update.php` | High
69 | File | `/admin/receipt.php` | High
70 | File | `/admin/redirect.php` | High
71 | File | `/admin/request-received-bydonar.php` | High
72 | File | `/admin/reservation.php` | High
73 | File | `/admin/role` | Medium
74 | File | `/admin/sales-reports-detail.php` | High
75 | File | `/admin/sensitive_word/list` | High
76 | File | `/admin/SystemConfiguration` | High
77 | File | `/admin/templets_one_edit.php` | High
78 | File | `/admin/update_room.php` | High
79 | File | `/admin/view-appointment.php` | High
80 | File | `/admin/view-enquiry.php` | High
81 | File | `/admin/view-patient.php` | High
82 | File | `/admin/view-progress-report.php` | High
83 | File | `/admin/viewpackage.php` | High
84 | File | `/admin/view_all_posts.php` | High
85 | File | `/admin/visitor-details.php` | High
86 | File | `/admin/voters_add.php` | High
87 | File | `/adminprofile.php` | High
88 | File | `/admin_route/inc_service_credits.php` | High
89 | File | `/adplanet/PlanetCommentList` | High
90 | File | `/agents/deploy/initiate.c` | High
91 | File | `/ajax.php?action=delete_borrower` | High
92 | File | `/ajax.php?action=delete_deductions` | High
93 | File | `/ajax.php?action=login` | High
94 | File | `/ajax.php?action=save_student` | High
95 | File | `/ajax/check_medicine_name.php` | High
96 | File | `/api/` | Low
97 | File | `/api/admin/store/product/list` | High
98 | File | `/api/admin/sys-file/upload` | High
99 | File | `/api/admin/system/store/order/list` | High
100 | File | `/api/controllers/merchant/app/ComboController.php` | High
101 | File | `/api/dept/build` | High
102 | File | `/api/job/add/` | High
103 | File | `/api/PlexAccount` | High
104 | File | `/api/v2/categories` | High
105 | File | `/api/v2/schema` | High
106 | File | `/api/wizard/getCapability` | High
107 | File | `/app-api/infra/file/upload` | High
108 | File | `/app-api/v1/members/openid/` | High
109 | File | `/app/api/controller/collect.php` | High
110 | File | `/app/zentao/module/repo/model.php` | High
111 | File | `/application/websocket/controller/Setting.php` | High
112 | File | `/assetsGroupReport/fixedAssetsList.j%73p` | High
113 | File | `/billing/pms_check.php` | High
114 | File | `/bin/ate` | Medium
115 | File | `/bin/httpd` | Medium
116 | File | `/Blood/A+.php` | High
117 | ... | ... | ...

There are 1035 more IOA items available (file, library, argument, input value, pattern, network port). Please use our online service to access the data.
