...
6 | File | `/admin/?page=orders/manage_request` | High
...
16 | File | `/admin/content/index` | High
17 | File | `/admin/employee_add.php` | High
18 | File | `/admin/employee_edit.php` | High
...
31 | File | `/admin/robot/approval/list` | High
32 | File | `/admin/service_requests/manage_inventory.php` | High
33 | File | `/admin/settings.php` | High
34 | File | `/admin/students/view_details.php` | High
35 | File | `/admin/uploads.php` | High
36 | File | `/admin/user/manage_user.php` | High
37 | File | `/admin/userprofile.php` | High
38 | File | `/adms/admin/?page=user/manage_user` | High
39 | File | `/adms/classes/Users.php` | High
40 | File | `/ajax.php?action=read_msg` | High
41 | File | `/api/admin/system/store/order/list` | High
42 | File | `/api/geojson` | Medium
43 | File | `/api/upload` | Medium
44 | File | `/api/user/password/sent-reset-email` | High
...
71 | File | `/goform/set_LimitClient_cfg` | High
