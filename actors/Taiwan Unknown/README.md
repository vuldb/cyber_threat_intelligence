...
11 | File | `/admin/configurations/userInfo` | High
...
21 | File | `/admin/misc/script-proxy` | High
...
26 | File | `/admin/sales/view_details.php` | High
...
34 | File | `/Application/Admin/Controller/ConfigController.class.php` | High
...
39 | File | `/circuits/circuit-types/` | High
40 | File | `/circuits/provider-accounts/` | High
...
46 | File | `/classes/Master.php?f=save_service` | High
47 | File | `/classes/Users.php` | High
48 | File | `/classes/Users.phpp` | High
49 | File | `/dcim/locations/` | High
50 | File | `/dcim/power-panels/` | High
51 | File | `/dcim/rack-roles/` | High
52 | File | `/dcim/rack/` | Medium
53 | File | `/dcim/regions/` | High
54 | File | `/dcim/site-groups/` | High
55 | File | `/dcim/sites/` | Medium
56 | File | `/dialog/select_media.php` | High
57 | File | `/dosen/data` | Medium
58 | File | `/E-mobile/App/System/File/downfile.php` | High
59 | File | `/Electron/download` | High
60 | File | `/feeds/post/publish` | High
61 | File | `/forms/doLogin` | High
62 | File | `/goForm/aspForm` | High
63 | File | `/goform/sysTools` | High
64 | File | `/hslist` | Low
65 | ... | ... | ...
