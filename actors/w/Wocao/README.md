...
30 | File | `/admin/assets/plugins/DataTables/media/unit_testing/templates/complex_header_2.php` | High
31 | File | `/admin/assets/plugins/DataTables/media/unit_testing/templates/deferred_table.php` | High
32 | File | `/admin/assets/plugins/DataTables/media/unit_testing/templates/dom_data.php` | High
33 | File | `/admin/assets/plugins/DataTables/media/unit_testing/templates/dom_data_th.php` | High
34 | File | `/admin/assets/plugins/DataTables/media/unit_testing/templates/dymanic_table.php` | High
...
38 | File | `/admin/book-details.php` | High
39 | File | `/admin/bwdates-report-details.php` | High
40 | File | `/admin/categories/update` | High
...
48 | File | `/admin/course_action.php` | High
49 | File | `/Admin/detail.php` | High
50 | File | `/admin/edit-brand.php` | High
51 | File | `/admin/edit-card-detail.php` | High
52 | File | `/admin/edit-category.php` | High
53 | File | `/admin/edit-customer-detailed.php` | High
54 | File | `/admin/edit-propertytype.php` | High
55 | File | `/admin/edit-services.php` | High
56 | File | `/admin/edit-user.php` | High
57 | File | `/admin/editorder.php` | High
58 | File | `/admin/edit_fuel.php` | High
...
64 | File | `/admin/login_process.php` | High
65 | File | `/admin/massage.php` | High
66 | File | `/admin/network/ajax_getChannelList` | High
67 | File | `/admin/network/diag_nslookup` | High
68 | File | `/admin/network/diag_ping6` | High
69 | File | `/admin/network/diag_pinginterface` | High
70 | File | `/admin/network/diag_traceroute` | High
71 | File | `/admin/network/diag_traceroute6` | High
72 | File | `/admin/network/wifi_schedule` | High
...
79 | File | `/admin/property-details.php` | High
80 | File | `/admin/publishnews.php` | High
81 | File | `/admin/registration.php` | High
82 | File | `/admin/room.php` | High
83 | File | `/admin/search-appointment.php` | High
84 | File | `/admin/search-maid.php` | High
85 | File | `/admin/search-medicalcard.php` | High
86 | File | `/admin/search-property.php` | High
87 | File | `/admin/search-vehicle.php` | High
88 | File | `/admin/services/view_service.php` | High
89 | File | `/admin/sn_package/sn_https` | High
90 | File | `/admin/state.php` | High
91 | File | `/admin/store.php` | High
92 | File | `/admin/student_action.php` | High
93 | File | `/admin/tag.php` | High
94 | File | `/admin/tag/save` | High
95 | File | `/admin/update_room.php` | High
96 | File | `/admin/update_user.php` | High
97 | File | `/admin/update_users.php` | High
98 | ... | ... | ...

There are 866 more IOA items available (file, library, argument, input value, pattern, network port). Please use our online service to access the data.
