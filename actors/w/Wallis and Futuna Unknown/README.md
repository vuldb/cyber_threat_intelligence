# Wallis and Futuna Unknown - Cyber Threat Intelligence
...
3 | File | `/admin_class.php?action=login` | High
4 | File | `/ajax/screenshot.php` | High
5 | File | `/api/baskets/{name}` | High
6 | File | `/api/v4/channels/{channel_id}/common_teams` | High
7 | File | `/apps/system/api/user.go` | High
8 | File | `/auth/session` | High
9 | File | `/check_availability.php` | High
10 | File | `/etc/passwd` | Medium
11 | File | `/goform/SetIpBind` | High
12 | ... | ... | ...
