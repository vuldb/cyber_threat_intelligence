# Wang Duo Yu - Cyber Threat Intelligence
...
_Tactics, techniques, and procedures_ (TTP) summarize the suspected MITRE ATT&CK techniques used by _Wang Duo Yu_. This data is unique as it uses our predictive model for actor profiling.
