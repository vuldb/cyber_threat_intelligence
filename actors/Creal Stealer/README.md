# Creal Stealer - Cyber Threat Intelligence
...
8 | File | `/api/system/sessions` | High
9 | File | `/app/api/controller/default/Sqlite.php` | High
10 | File | `/BRS_netgear_success.html` | High
11 | File | `/cgi-bin/cstecgi.cgi` | High
12 | File | `/cgi-bin/cstecgi.cgi?action=login` | High
13 | File | `/cgi-bin/system_mgr.cgi` | High
14 | File | `/dana-admin/user/update.cgi` | High
15 | File | `/dashboard/deposit` | High
16 | File | `/goform/setAutoPing` | High
17 | File | `/home/<user>/SecurityOnion/setup/so-setup` | High
18 | File | `/importexport.php` | High
19 | File | `/login` | Low
20 | File | `/LoginAdmin` | Medium
21 | File | `/myprofile.php` | High
22 | File | `/rom-0` | Low
23 | File | `/scripts/uistrings.cgi` | High
24 | File | `/Supply_Management_System/admin/edit_retailer.php` | High
