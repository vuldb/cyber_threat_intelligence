# FakeUpdateRU - Cyber Threat Intelligence
...
2 | File | `/api/code/upload` | High
3 | File | `/boafrm/formMultiAP` | High
4 | File | `/boafrm/formSysLog` | High
5 | File | `/boafrm/formWlanRedirect` | High
6 | File | `/comfy/utils.py` | High
7 | File | `/function/customer_signup.php` | High
8 | File | `/goform/setRateTest` | High
9 | ... | ... | ...
