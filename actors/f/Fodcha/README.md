...
32 | File | `/api/public/signup` | High
33 | File | `/api/v1/attack` | High
34 | File | `/api/v1/attack/falco` | High
35 | File | `/api/v2/open/rowsInfo` | High
36 | File | `/aqpg/users/login.php` | High
37 | File | `/balance/service/list` | High
38 | File | `/bcms/admin/?page=user/list` | High
39 | File | `/bsms_ci/index.php` | High
...
49 | File | `/csms/admin/?page=system_info` | High
...
59 | File | `/employeeview.php` | High
60 | File | `/event/admin/?page=user/list` | High
61 | File | `/ext/collect/filter_text.do` | High
62 | File | `/face-recognition-php/facepay-master/camera.php` | High
63 | File | `/firewall/urlblist.php` | High
64 | File | `/goform/DhcpSetSer` | High
65 | File | `/goform/operateMacFilter` | High
66 | File | `/goform/setMacFilterList` | High
67 | File | `/goform/SetSysTimeCfg` | High
68 | File | `/goform/WriteFacMac` | High
69 | File | `/hrm/controller/employee.php` | High
70 | File | `/importhtml.php` | High
71 | File | `/index.php` | Medium
72 | File | `/index.php/purchase_order/browse_data` | High
73 | File | `/index.php?app=main&inc=feature_phonebook&op=phonebook_list` | High
74 | File | `/index.php?id=userProfileEdit` | High
75 | File | `/librarian/bookdetails.php` | High
76 | File | `/login` | Low
77 | File | `/loginVaLidation.php` | High
78 | File | `/mims/app/addcustomerHandler.php` | High
79 | File | `/mims/login.php` | High
80 | ... | ... | ...
