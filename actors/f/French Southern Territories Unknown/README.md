# French Southern Territories Unknown - Cyber Threat Intelligence
...
2 | File | `/cms/collect/getArticle` | High
3 | File | `/my_photo_gallery/image.php` | High
4 | File | `/pms/ajax/check_user_name.php` | High
5 | File | `/uncpath/` | Medium
6 | File | `/user_images/` | High
7 | ... | ... | ...
