# Federated States of Micronesia Unknown - Cyber Threat Intelligence
...
9 | File | `/admin/teachers.php` | High
...
18 | File | `/auth/list_projects` | High
19 | File | `/b2b-supermarket/shopping-cart` | High
20 | File | `/bill/add_bill.php` | High
21 | File | `/billing/pms_check.php` | High
22 | File | `/bin/sh` | Low
...
29 | File | `/cgi-bin/login.cgi` | High
...
34 | File | `/common/download?filename=1.jsp&delete=false` | High
35 | File | `/controller/api/hotelList.php` | High
36 | File | `/crm/weixinmp/index.php?userid=123&module=Users&usid=1&action=UsersAjax&minipro_const_type=1&related_module=Singin` | High
37 | File | `/database?action=GetDatabaseAccess` | High
38 | File | `/debug/pprof` | Medium
39 | File | `/devinfo` | Medium
40 | File | `/equipment/get_Information` | High
41 | File | `/etc/hosts.deny` | High
42 | File | `/getmaxun/maxun/blob/develop/server/src/routes/auth.ts` | High
43 | File | `/goform/addStaProfile` | High
44 | File | `/goform/AdvSetWrlsafeset` | High
45 | File | `/goform/aspApBasicConfigUrcp` | High
46 | File | `/goform/aspChangeChannel` | High
47 | ... | ... | ...
