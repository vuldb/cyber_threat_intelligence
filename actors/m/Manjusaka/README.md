...
These _countries_ are directly (e.g. origin of attacks) or indirectly (e.g. access by proxy) associated with Manjusaka:
...
2 | [45.137.117.219](https://vuldb.com/?ip.45.137.117.219) | - | - | High
3 | [71.115.193.247](https://vuldb.com/?ip.71.115.193.247) | pool-71-115-193-247.syrcny.fios.verizon.net | - | High
4 | ... | ... | ... | ...
...
_Tactics, techniques, and procedures_ (TTP) summarize the suspected MITRE ATT&CK techniques used by _Manjusaka_. This data is unique as it uses our predictive model for actor profiling.
...
These _indicators of attack_ (IOA) list the potential fragments used for technical activities like reconnaissance, exploitation, privilege escalation, and exfiltration by Manjusaka. This data is unique as it uses our predictive model for actor profiling.
...
5 | File | `/goform/WifiGuestSet` | High
6 | File | `/manage/IPSetup.php` | High
7 | ... | ... | ...
