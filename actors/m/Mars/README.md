# Mars - Cyber Threat Intelligence
...
2 | Library | `C:\Program Files\OEM\MECHREVO Control Center\UniwillService\MyControlCenter\csCAPI.dll` | High
3 | Library | `gcapi.dll` | Medium
4 | ... | ... | ...
