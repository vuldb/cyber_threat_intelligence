...
7 | File | `/admin/assets/plugins/DataTables/media/unit_testing/templates/dymanic_table.php` | High
8 | File | `/admin/doctor-specilization.php` | High
9 | File | `/admin/edit-card-detail.php` | High
