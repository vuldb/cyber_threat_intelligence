...
3 | File | `/film-rating.php` | High
4 | File | `/index.php` | Medium
5 | File | `/librarian/bookdetails.php` | High
6 | File | `/module/admin_bp/add_application.php` | High
7 | File | `/module/report_event/index.php` | High
...
12 | File | `admin/establishment/manage.php` | High
