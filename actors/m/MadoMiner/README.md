...
24 | File | `/admin/request-received-bydonar.php` | High
25 | File | `/admin/reservation_view.php` | High
26 | File | `/admin/salary_slip.php` | High
27 | File | `/admin/sales/index.php` | High
...
34 | File | `/ajax.php?action=save_membership` | High
35 | File | `/api/client/editemedia.php` | High
36 | File | `/api/comment/add` | High
37 | File | `/api/Common/uploadFile` | High
38 | File | `/Api/FileUpload.ashx?method=DoUpload` | High
...
45 | File | `/boafrm/formReflashClientTbl` | High
46 | File | `/book_edit_do.html` | High
...
55 | File | `/cms/smf/Sources/ManageMembers.php` | High
56 | File | `/company/service/increment/add/im` | High
57 | File | `/confirmbooking.php` | High
58 | File | `/control/login.php` | High
...
65 | File | `/fladmin/user_recoverpwd.php` | High
66 | ... | ... | ...
