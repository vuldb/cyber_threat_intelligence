...
9 | File | `/admin/manage-tickets.php` | High
10 | File | `/admin/pages/` | High
11 | File | `/admin/video/list` | High
12 | File | `/adminlogin.asp` | High
13 | File | `/admins` | Low
14 | File | `/ajax.php?action=update_account` | High
...
44 | File | `/H5/versionupdate.data` | High
45 | File | `/include/file.php` | High
46 | File | `/install/installdb.php` | High
47 | File | `/login` | Low
48 | File | `/manage_block.php` | High
