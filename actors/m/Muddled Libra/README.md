...
17 | File | `/admin/complaint-details.php` | High
...
28 | File | `/admin/index.php/web/ajax_all_lists` | High
...
36 | File | `/admin/suppliercontroller.php` | High
37 | File | `/admin/template/update` | High
38 | File | `/admin/user-profile.php` | High
