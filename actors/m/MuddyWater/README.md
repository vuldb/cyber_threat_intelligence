...
-- | --------- | -------- | ----------- | ----------
1 | T1006 | CWE-22, CWE-23, CWE-24, CWE-36, CWE-41, CWE-425 | Path Traversal | High
...
33 | File | `/admin/search-report-details.php` | High
34 | File | `/admin/view-pass-detail.php` | High
35 | File | `/admin/View_user.php` | High
36 | File | `/adminUser/updateImg` | High
37 | File | `/ajax_state.php` | High
38 | File | `/api/core/mod.rs` | High
39 | File | `/api/esps` | Medium
...
44 | File | `/app/search/table` | High
45 | File | `/auth.asp` | Medium
46 | File | `/auth/setup` | Medium
47 | File | `/auth/soup-auth-digest.c` | High
48 | File | `/authenticate.php` | High
49 | File | `/auth_files/photo/` | High
50 | File | `/bin/goahead` | Medium
51 | File | `/bin/gpio` | Medium
52 | File | `/bin/httpd` | Medium
53 | File | `/binutils/debug.c` | High
54 | File | `/blog-details.php` | High
