...
17 | File | `/admin/communitymanagement.php` | High
18 | File | `/admin/contactus.php` | High
19 | File | `/admin/div_data/delete?divId=9` | High
...
32 | File | `/admin/menu_update.php` | High
33 | File | `/admin/modal_add_product.php` | High
34 | File | `/admin/project/update/2` | High
35 | File | `/admin/students/manage.php` | High
36 | File | `/admin/success_story.php` | High
