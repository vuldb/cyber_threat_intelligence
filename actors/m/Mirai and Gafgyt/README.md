# Mirai and Gafgyt - Cyber Threat Intelligence
...
2 | File | `/bin/goahead` | Medium
3 | File | `/crm/weixinmp/index.php?userid=123&module=Users&usid=1&action=UsersAjax&minipro_const_type=1&related_module=Singin` | High
4 | ... | ... | ...
