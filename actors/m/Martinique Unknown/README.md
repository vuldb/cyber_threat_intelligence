...
33 | [46.238.182.0](https://vuldb.com/?ip.46.238.182.0) | - | - | High
...
55 | File | `/admin/list_ipAddressPolicy.php` | High
...
90 | File | `/adphar.php` | Medium
91 | File | `/ajax.php?action=delete_loan` | High
92 | File | `/ajax.php?action=save_plan` | High
...
106 | File | `/Applications/Steal/main.cpp` | High
107 | File | `/auth/delete_project/` | High
108 | File | `/auth/user/all.api` | High
109 | File | `/bank/statements.php` | High
110 | File | `/bank/transfer.php` | High
111 | File | `/bbdms/admin/update-contactinfo.php` | High
112 | File | `/billaction.php` | High
...
123 | File | `/browsemdcn.php` | High
124 | File | `/bwdates-report-ds.php` | High
125 | File | `/bwdates-report-result.php` | High
126 | ... | ... | ...

There are 1120 more IOA items available (file, library, argument, input value, pattern, network port). Please use our online service to access the data.
