...
29 | File | `/admin/attachment/download` | High
...
39 | File | `/admin/courses/manage_course.php` | High
...
54 | File | `/admin/list_ipAddressPolicy.php` | High
...
108 | File | `/auth/delete_project/` | High
...
116 | File | `/boafrm/formDebugDiagnosticRun` | High
