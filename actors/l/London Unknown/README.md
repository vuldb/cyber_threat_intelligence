...
12 | File | `/car-rental-management-system/admin/index.php?page=manage_car` | High
...
36 | File | `/ordering/admin/store/index.php?view=edit` | High
...
42 | File | `/style/` | Low
43 | File | `/tableedit.php#page=editprice` | High
44 | File | `/timeline2.php` | High
45 | File | `/uncpath/` | Medium
46 | File | `/useratte/inc/userattea.php` | High
47 | File | `/usr/sbin/suexec` | High
48 | File | `/vendor/htmlawed/htmlawed/htmLawedTest.php` | High
49 | File | `/view/show_student2.php` | High
50 | File | `/view/timetable_update_form.php` | High
51 | File | `/WEB-INF/web.xml` | High
52 | File | `/xwiki/bin/edit//?content=%7B%7Bgroovy%7D%7Dprintln%28%22Hello+from+Groovy%21%22%29%7B%7B%2Fgroovy%7D%7D&xpage=view` | High
53 | File | `123flashchat.php` | High
54 | File | `actions/doreport.php` | High
55 | File | `adclick.php` | Medium
56 | File | `add-testimonial.php` | High
57 | File | `add_comment.php` | High
58 | File | `admin.php3` | Medium
59 | File | `admin/admin_users.php` | High
60 | File | `admin/index.php` | High
61 | File | `admin/index.php?id=themes&action=edit_chunk` | High
62 | File | `admin/modules_data.php` | High
63 | File | `admincp/attachment.php` | High
64 | File | `admincp/search.php?do=dosearch` | High
65 | File | `admin_groups.php` | High
66 | File | `ajax/api/hook/decodeArguments` | High
67 | File | `ajax/render/widget_tabbedcontainer_tab_panel` | High
68 | File | `album_cat.php` | High
69 | File | `and/or` | Low
70 | File | `announcement.php` | High
71 | File | `api.php` | Low
72 | File | `application/index/common.php` | High
73 | File | `application/shop/controller/member.php` | High
74 | File | `auction_offer.php` | High
75 | File | `audioflinger/Threads.cpp` | High
76 | File | `bb_usage_stats.php` | High
77 | File | `blog.php` | Medium
78 | File | `board.php` | Medium
79 | File | `boardData103.php/boardDataJP.php/boardDataNA.php/boardDataWW.php` | High
80 | File | `booth.php` | Medium
81 | File | `Bootstrap.log` | High
82 | File | `ca000007.pl` | Medium
83 | File | `calendar.php` | Medium
84 | File | `calendar/submit/` | High
85 | ... | ... | ...
