...
24 | File | `/api/wizard/networkSetup` | High
...
39 | File | `/config/config.properties` | High
40 | File | `/coreframe/app/guestbook/myissue.php` | High
41 | File | `/course/modedit.php` | High
