...
39 | File | `/admin/content/filemanager/uploads` | High
40 | File | `/admin/delete_s7.php` | High
...
64 | File | `/admin/pages/list` | High
65 | File | `/admin/pass-bwdates-report.php` | High
66 | File | `/admin/photo.php` | High
67 | File | `/admin/php/crud.php` | High
68 | File | `/admin/profile.php` | High
69 | File | `/admin/room.php` | High
70 | File | `/admin/roombook.php` | High
71 | File | `/admin/roomdel.php` | High
72 | File | `/admin/salary_slip.php` | High
73 | File | `/admin/sales-reports-detail.php` | High
74 | File | `/admin/session.php` | High
75 | File | `/admin/slideupdate.php` | High
76 | File | `/admin/store/edit/` | High
...
82 | File | `/admin/users-applications.php` | High
83 | File | `/admin/view-enquiry.php` | High
84 | File | `/admin/view-member-report.php` | High
85 | File | `/admin/view-progress-report.php` | High
...
90 | File | `/ajax.php?action=save_payment` | High
91 | File | `/ajax.php?action=save_student` | High
92 | File | `/ajax.php?action=save_supplier` | High
93 | File | `/aloneReport/index.do/../../aloneReport/download.do;othersusrlogout.do` | High
94 | File | `/api/backend/core/web-file-upload/upload` | High
95 | File | `/api/backend/v1/user/create` | High
96 | File | `/api/config/list` | High
97 | File | `/api/es/admin/v3/security/user/1` | High
98 | File | `/api/esps` | Medium
99 | File | `/api/file/downloadfile` | High
100 | File | `/api/file/s3/get-presigned-get-url-proxy` | High
...
104 | File | `/api/wechat/app_auth` | High
105 | File | `/api/wizard/getDualbandSync` | High
106 | File | `/app-api/infra/file/upload` | High
