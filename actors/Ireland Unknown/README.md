...
55 | File | `/leave_system/classes/SystemSettings.php?f=update_settings` | High
56 | File | `/log/decodmail.php` | High
57 | File | `/log/download.php` | High
58 | File | `/login` | Low
59 | File | `/mail.php` | Medium
60 | ... | ... | ...
