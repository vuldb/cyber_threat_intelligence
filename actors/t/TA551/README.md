...
43 | File | `/admin/list_localuser.php` | High
44 | File | `/admin/manage-pages.php` | High
45 | File | `/admin/manage-users.php` | High
...
50 | File | `/admin/pages/subjects.php` | High
51 | File | `/admin/pages/yearlevel.php` | High
52 | File | `/admin/product/manage_product.php` | High
53 | File | `/admin/project/update/2` | High
54 | File | `/admin/reg.php` | High
