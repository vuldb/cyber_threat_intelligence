...
15 | File | `/admin/action/delete-vaccine.php` | High
...
22 | File | `/admin/ajax.php?action=confirm_order` | High
...
28 | File | `/admin/category/cate-edit-run.php` | High
...
42 | File | `/admin/index.php?act=reset_admin_psw` | High
