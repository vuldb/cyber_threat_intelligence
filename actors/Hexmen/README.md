# Hexmen - Cyber Threat Intelligence

These _indicators_ were collected during the [VulDB CTI analysis](https://vuldb.com/?kb.cti) of the actor known as [Hexmen](https://vuldb.com/?actor.hexmen). The _activity monitoring_ correlates data from social media, forums, chat rooms, and darknet markets. It helps to determine associated actors, specific activities, expected intentions, emerging research, and ongoing attacks. Our unique _predictive model_ is able to forecast activities and their characteristics.
...
-- | ---------- | -------- | -------- | ----------
1 | 58.218.200.2 | - | - | High
2 | 103.42.180.113 | - | - | High
3 | 103.230.108.85 | - | - | High
4 | 114.115.209.191 | ecs-114-115-209-191.compute.hwclouds-dns.com | - | High
5 | 119.28.133.78 | - | - | High
6 | 119.249.54.119 | - | - | High
7 | ... | ... | ... | ...
...
_Tactics, techniques, and procedures_ (TTP) summarize the suspected ATT&CK techniques used by Hexmen. This data is unique as it uses our predictive model for actor profiling.
