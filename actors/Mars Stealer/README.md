...
13 | File | `/api/controllers/admin/app/ComboController.php` | High
...
44 | File | `/manage_laundry.php` | High
45 | File | `/mifs/c/i/reg/reg.html` | High
46 | File | `/model/update_subject.php` | High
47 | File | `/netflow/jspui/editProfile.jsp` | High
48 | File | `/portmap` | Medium
49 | File | `/register.php` | High
50 | File | `/search/index` | High
51 | File | `/settings/download-test-pdf` | High
52 | ... | ... | ...
