...
8 | File | `/admin/admin_content_tag.php?action=save_content` | High
...
12 | File | `/admin/assign/assign.php` | High
13 | File | `/admin/bookings/view_booking.php` | High
...
17 | File | `/admin/conferences/get-all-status/` | High
18 | File | `/admin/conferences/list/` | High
19 | File | `/admin/config_save.php` | High
...
33 | File | `/admin/list_onlineuser.php` | High
...
41 | File | `/admin/positions_delete.php` | High
42 | File | `/admin/products/view_product.php` | High
43 | File | `/admin/reminders/manage_reminder.php` | High
44 | File | `/admin/report/index.php` | High
45 | File | `/admin/reports/index.php` | High
