# Haiti Unknown - Cyber Threat Intelligence
...
5 | File | `/admin/add_title.php` | High
...
12 | File | `/admin/content/index` | High
...
18 | File | `/admin/info_deal.php` | High
...
27 | File | `/admin/save_airlines.php` | High
28 | File | `/admin/search-vehicle.php` | High
29 | File | `/admin/search.php` | High
30 | File | `/admin/settings/users/edit/` | High
31 | File | `/admin/subcategory.php` | High
...
43 | File | `/api/api.php?mod=upload&type=1` | High
...
48 | File | `/app/admin/view/web_user.html` | High
49 | File | `/app/sys1.php` | High
50 | File | `/application/controller/Pelanggan.php` | High
51 | File | `/auth/delete_project/` | High
52 | File | `/author_posts.php` | High
53 | File | `/backup.pl` | Medium
54 | File | `/bill/add_bill.php` | High
55 | File | `/boafrm/formDebugDiagnosticRun` | High
56 | File | `/boafrm/formParentControl` | High
57 | File | `/branch_viewmore.php` | High
58 | File | `/bwdates-report-ds.php` | High
59 | File | `/C6/JHSoft.Web.AcceptAip/AcceptShow.aspx/` | High
