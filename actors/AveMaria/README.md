...
48 | File | `/trx_addons/v2/get/sc_layout` | High
49 | File | `/uncpath/` | Medium
50 | File | `/upload/catalog/controller/account/password.php` | High
...
54 | File | `/web/api/app/Controller/HostController.php` | High
55 | ... | ... | ...
