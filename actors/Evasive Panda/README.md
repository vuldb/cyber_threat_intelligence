# Evasive Panda - Cyber Threat Intelligence
...
25 | File | `/modules/registration_admission/patient_register.php` | High
26 | File | `/nova/bin/detnet` | High
27 | File | `/ocwbs/classes/Master.php?f=delete_service` | High
28 | File | `/property` | Medium
29 | File | `/publisher` | Medium
30 | File | `/recordings/index.php` | High
31 | File | `/rest/api/2/user/picker` | High
32 | File | `/search.php` | Medium
33 | File | `/sys/class/zram-control/hot_add` | High
34 | File | `/tmp/portmap.xdr` | High
