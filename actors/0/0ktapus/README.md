...
5 | T1068 | CWE-250, CWE-264, CWE-266, CWE-269, CWE-270, CWE-274, CWE-284 | Execution with Unnecessary Privileges | High
6 | ... | ... | ... | ...
...
7 | File | `/admin/actions/check-attendance.php` | High
...
25 | File | `/admin/includes/edit_post.php` | High
26 | File | `/admin/index.php?page=user-profile` | High
...
43 | File | `/Administrator/PHP/AdminUpdateUser.php` | High
44 | File | `/ajax.php?action=save_borrower` | High
45 | File | `/ajax.php?action=save_payroll` | High
46 | File | `/ajax.php?Ajax=GetModal_Sensor_Graph` | High
47 | File | `/all-tickets.php` | High
...
53 | File | `/api/wizard/setLanguage` | High
