# SMSspy - Cyber Threat Intelligence
...
7 | File | `/goform/setStaticRoute` | High
8 | File | `/HNAP1` | Low
...
36 | File | `blocks/block-Old_Articles.php` | High
