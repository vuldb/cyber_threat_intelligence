...
12 | File | `/etc/openshift/server_priv.pem` | High
13 | File | `/export` | Low
14 | File | `/file?action=download&file` | High
15 | File | `/goform/openSchedWifi` | High
...
32 | File | `/protocol/index.php` | High
33 | ... | ... | ...
