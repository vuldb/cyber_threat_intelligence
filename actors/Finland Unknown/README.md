...
57 | File | `/jeecg-boot/sys/common/upload` | High
58 | File | `/jobinfo/` | Medium
59 | File | `/listplace/user/ticket/create` | High
60 | File | `/load.php` | Medium
