...
2 | File | `/add_command` | Medium
3 | File | `/admin/?page=system_info/contact_info` | High
4 | File | `/admin/about.php` | High
...
10 | File | `/admin/assets/plugins/DataTables/media/unit_testing/templates/dom_data.php` | High
...
14 | File | `/admin/change-emailid.php` | High
...
19 | File | `/admin/customer-list.php` | High
20 | File | `/Admin/delete-fee.php` | High
21 | File | `/admin/edit-brand.php` | High
22 | File | `/admin/edit-user.php` | High
23 | File | `/admin/editsite.php` | High
24 | File | `/admin/index.php` | High
25 | File | `/admin/index2.html` | High
26 | File | `/admin/menu.php` | High
27 | File | `/admin/quote-details.php` | High
28 | File | `/admin/sales-reports-detail.php` | High
29 | File | `/admin/search-property.php` | High
30 | File | `/admin/state.php` | High
31 | File | `/admin/student-registration.php` | High
32 | File | `/admin/students/manage_academic.php` | High
33 | File | `/admin/transaction/deposit` | High
34 | File | `/admin/user-bookings.php` | High
35 | File | `/admin/yesterday-reg-users.php` | High
36 | File | `/ajax.php?action=calculate_payroll` | High
37 | File | `/anchor/admin/categories/delete/2` | High
38 | File | `/api/files/recipepictures/` | High
39 | File | `/api/wizard/getBasicInfo` | High
40 | File | `/bbdms/admin/update-contactinfo.php` | High
41 | File | `/binutils/debug.c` | High
42 | File | `/boafrm/formDdns` | High
