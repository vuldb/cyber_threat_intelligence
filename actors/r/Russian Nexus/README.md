...
16 | File | `/admin/edit-card-detail.php` | High
17 | File | `/admin/edit_fuel.php` | High
...
32 | File | `/admin/view-card-detail.php` | High
33 | File | `/adminapi/system/crud` | High
34 | File | `/adminapi/system/file/openfile` | High
35 | File | `/api/v1/custom_component` | High
...
50 | File | `/cms/admin/maintenance/manage_service.php` | High
51 | File | `/cms/ajax.php` | High
