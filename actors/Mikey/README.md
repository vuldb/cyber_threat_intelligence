...
55 | File | `/MicroStrategyWS/happyaxis.jsp` | High
56 | File | `/mims/app/addcustomerHandler.php` | High
57 | File | `/mkshope/login.php` | High
58 | ... | ... | ...
