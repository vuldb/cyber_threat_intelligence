...
33 | File | `/admin/cmsTagType/save` | High
...
38 | File | `/admin/course_action.php` | High
39 | File | `/admin/create_product.php` | High
40 | File | `/Admin/detail.php` | High
...
51 | File | `/admin/login_process.php` | High
...
57 | File | `/admin/network/diag_pinginterface` | High
...
67 | File | `/admin/publishnews.php` | High
68 | File | `/admin/registration.php` | High
69 | File | `/admin/report.php` | High
