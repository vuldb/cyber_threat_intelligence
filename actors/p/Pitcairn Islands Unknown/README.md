# Pitcairn Islands Unknown - Cyber Threat Intelligence
...
19 | File | `/config/config.json` | High
...
* https://github.com/firehol/blocklist-ipsets/blob/master/ipip_country/ipip_country_pn.netset
