...
-- | --------- | -------- | ----------- | ----------
1 | T1006 | CWE-21, CWE-22, CWE-23, CWE-27, CWE-28, CWE-36, CWE-425 | Path Traversal | High
...
9 | File | `/add-computer.php` | High
10 | File | `/add-pass.php` | High
11 | File | `/add-table.php` | High
12 | File | `/addCandidate.php` | High
13 | File | `/admin#themes` | High
14 | File | `/admin-cp/logs/email` | High
15 | File | `/admin-profile.php` | High
16 | File | `/admin/accepted-appointment.php` | High
...
22 | File | `/admin/bookList?page=1&limit=10` | High
23 | File | `/admin/case-type` | High
24 | File | `/admin/category/view_category.php` | High
25 | File | `/Admin/changepassword.php` | High
26 | File | `/admin/checklogin.php` | High
27 | File | `/admin/contact-us.php` | High
28 | File | `/admin/Create_category.php` | High
29 | File | `/admin/create_product.php` | High
30 | File | `/admin/delete_activity.php` | High
31 | File | `/admin/delete_expenses.php` | High
32 | File | `/admin/delete_file.php` | High
...
37 | File | `/admin/ind_backstage.php` | High
38 | File | `/admin/login.php` | High
39 | File | `/admin/manage-admins.php` | High
40 | File | `/admin/manage-art-medium.php` | High
41 | File | `/admin/manage-services.php` | High
42 | File | `/admin/manage-subadmins.php` | High
43 | File | `/admin/manage-users.php` | High
44 | File | `/admin/manage_user.php` | High
45 | File | `/admin/menu.php` | High
46 | File | `/admin/modules/course/index.php` | High
