# UNC2198 - Cyber Threat Intelligence
...
31 | File | `/admin/employee_row.php` | High
32 | File | `/admin/featured.php` | High
33 | File | `/admin/invoice.php` | High
34 | File | `/admin/list_localuser.php` | High
35 | File | `/admin/login.php` | High
36 | File | `/admin/maintenance/brand.php` | High
...
42 | File | `/admin/read.php?mudi=getSignal` | High
43 | File | `/admin/regester.php` | High
44 | File | `/admin/searchview.php` | High
45 | File | `/admin/students/manage.php` | High
46 | File | `/admin/suppliers/view_details.php` | High
47 | File | `/admin/sys_sql_query.php` | High
48 | File | `/admin/vacancy/index.php` | High
49 | File | `/admin_route/inc_service_credits.php` | High
50 | File | `/ajax-files/followBoard.php` | High
51 | File | `/ajax-files/postComment.php` | High
52 | File | `/ajax.php?action=read_msg` | High
53 | File | `/anony/mjpg.cgi` | High
