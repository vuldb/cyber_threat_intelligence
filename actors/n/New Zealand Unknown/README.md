...
19 | File | `/admin/manage-services.php` | High
...
26 | File | `/admin/user.php` | High
27 | File | `/adminPage/main/upload` | High
28 | File | `/adminpanel/admin/query/addCourseExe.php` | High
29 | File | `/api/controllers/merchant/app/ComboController.php` | High
30 | File | `/api/dept/build` | High
...
36 | File | `/archibus/login.axvw` | High
37 | File | `/auth.asp` | Medium
38 | File | `/auth/register` | High
