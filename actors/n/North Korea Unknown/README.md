...
9 | File | `/config/config.json` | High
...
18 | File | `/I/list.php` | Medium
19 | File | `/index.lua?pageID=Administration` | High
20 | File | `/index.lua?pageID=Phone%20book` | High
21 | File | `/manage_user.php` | High
22 | File | `/mifs/c/i/reg/reg.html` | High
23 | File | `/omps/seller` | Medium
24 | File | `/p` | Low
