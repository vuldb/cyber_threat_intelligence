...
35 | File | `/Wedding-Management/admin/client_manage_account_details.php?booking_id=31` | High
...
43 | File | `admin/adminsignin.html` | High
44 | File | `admin/category.inc.php` | High
45 | File | `admin/editproductetails.php` | High
46 | File | `admin/main.asp` | High
47 | File | `admin/movieview.php` | High
48 | File | `admin/versions.html` | High
49 | File | `admin/y_admin.asp` | High
50 | File | `adminBackupdatabase.php` | High
...
59 | File | `army.php` | Medium
60 | File | `attendancy.php` | High
61 | File | `AttributionSource.java` | High
62 | File | `auth-gss2.c` | Medium
63 | File | `auth.php` | Medium
64 | File | `awstats.pl` | Medium
65 | File | `bb-login.php` | Medium
66 | File | `bb_admin.php` | Medium
67 | ... | ... | ...
