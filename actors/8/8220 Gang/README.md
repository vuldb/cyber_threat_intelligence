...
35 | File | `/admin/notes/create` | High
...
50 | File | `/ajax.php?action=delete_member` | High
...
55 | File | `/api/swaggerui/static` | High
56 | File | `/api/sys/login` | High
57 | File | `/api/v4/users` | High
58 | File | `/api/wizard/getCapability` | High
59 | File | `/app/api/v1/openvpn.py` | High
60 | File | `/app/controller/Api.php` | High
61 | File | `/app/index/controller/Common.php` | High
62 | File | `/app/register.php?action=reg` | High
63 | File | `/app/sys1.php` | High
64 | File | `/applications/core/modules/admin/editor/toolbar.php` | High
65 | File | `/Applications/Google\ Drive.app/Contents/MacOS` | High
66 | File | `/applications/nexus/modules/front/store/store.php` | High
67 | File | `/assetsGroupReport/assetsService.j%73p` | High
