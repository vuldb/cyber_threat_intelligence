...
14 | File | `/audimex/cgi-bin/wal.fcgi` | High
...
26 | File | `/common/ticket_associated_tickets.php` | High
27 | File | `/crmeb/crmeb/services/UploadService.php` | High
28 | File | `/dashboard/createblog` | High
...
44 | File | `/jeecg-boot/jmreport/upload` | High
...
51 | File | `/php-sms/classes/Master.php?f=save_quote` | High
52 | File | `/portal/reports/account_statement` | High
53 | File | `/preview.php` | Medium
54 | File | `/property` | Medium
55 | File | `/robots.txt` | Medium
56 | File | `/search` | Low
57 | File | `/send_order.cgi?parameter=restart` | High
58 | File | `/signup_script.php` | High
59 | File | `/sys/dict/loadTreeData` | High
60 | File | `/SysInfo.htm` | Medium
61 | ... | ... | ...
