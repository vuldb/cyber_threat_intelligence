...
46 | File | `/system/WCore/WHelper.php` | High
47 | File | `/uncpath/` | Medium
48 | File | `/upload` | Low
49 | File | `/uploads/tags.php` | High
50 | File | `/userfs/bin/tcapi` | High
51 | File | `/var/www/xms/application/config/config.php` | High
52 | File | `/var/www/xms/application/controllers/gatherLogs.php` | High
53 | File | `/var/www/xms/application/controllers/verifyLogin.php` | High
54 | File | `/var/www/xms/cleanzip.sh` | High
55 | File | `/vendor/phpdocumentor/reflection-docblock/tests/phpDocumentor/Reflection/DocBlock/Tag/LinkTagTeet.php` | High
56 | File | `/wbms/classes/Master.php?f=delete_client` | High
57 | File | `/websocket/exec` | High
58 | File | `/workspaceCleanup` | High
59 | ... | ... | ...
