# ChaChi - Cyber Threat Intelligence
...
6 | File | `/administrator/addcategory.php` | High
7 | File | `/api/swaggerui/static` | High
8 | File | `/cgi-bin/activate.cgi` | High
9 | File | `/cgi-bin/koha/acqui/supplier.pl?op=enter` | High
...
18 | File | `/guestbook` | Medium
19 | File | `/index.php` | Medium
20 | File | `/intrams_sams/manage_student.php` | High
...
29 | File | `/product.php` | Medium
30 | File | `/REBOOTSYSTEM` | High
31 | File | `/req_password_user.php` | High
32 | File | `/schedule_edit1.php` | High
33 | File | `/services` | Medium
34 | File | `/Setting/change_password_save` | High
35 | File | `/smsa/add_class_submit.php` | High
36 | File | `/spip.php` | Medium
37 | File | `/stockmovment/stockmovment/delete/` | High
