...
20 | File | `/adminpanel/admin/query/deleteCourseExe.php` | High
21 | File | `/ajax.php?action=login` | High
22 | File | `/api/backend/core/web-file-upload/upload` | High
23 | File | `/api/baskets/{name}` | High
24 | File | `/API/info` | Medium
25 | File | `/api/jmeter/download/files` | High
...
50 | File | `/emgui/rest/preferences/PREF_HOME_PAGE/sponsor/3/` | High
51 | File | `/endpoint/delete-computer.php` | High
52 | File | `/endpoint/delete-expense.php` | High
