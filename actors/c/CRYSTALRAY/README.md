# CRYSTALRAY - Cyber Threat Intelligence
...
2 | File | `/admin/checklogin.php` | High
3 | File | `/admin/index.php` | High
4 | File | `/AGE0000700/GetImageMedico?fooId=1` | High
5 | File | `/ajax/action.php` | High
6 | File | `/dashboard/fees/fee-invoices/` | High
7 | ... | ... | ...
