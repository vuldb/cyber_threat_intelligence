...
18 | File | `/admin/file.php` | High
19 | File | `/admin/index.php` | High
20 | File | `/admin/index.php?act=reset_admin_psw` | High
21 | File | `/admin/index.php?page=user-profile` | High
22 | File | `/admin/index3.php` | High
...
30 | File | `/admin/sales/view_details.php` | High
31 | File | `/admin/service.php` | High
32 | File | `/admin/students/manage_academic.php` | High
33 | File | `/admin/test_status.php` | High
34 | File | `/admin/theme-edit.php` | High
35 | File | `/admin/view_sendlist.php` | High
...
57 | File | `/cms/notify` | Medium
58 | File | `/dashboard/message` | High
59 | File | `/depotHead/list` | High
60 | File | `/device/signin` | High
61 | File | `/devinfo` | Medium
62 | File | `/dipam/save-delegates.php` | High
63 | File | `/general/attendance/manage/ask_duty/delete.php` | High
64 | File | `/general/email/outbox/delete.php` | High
65 | File | `/general/ipanel/menu_code.php?MENU_TYPE=FAV` | High
66 | File | `/goform/addressNat` | High
67 | File | `/goform/RGFirewallEL` | High
68 | File | `/goform/SetOnlineDevName` | High
69 | File | `/goform/SetSysAutoRebbotCfg` | High
70 | File | `/goform/WifiBasicSet` | High
71 | File | `/goform/wifiSSIDset` | High
72 | File | `/h/` | Low
73 | File | `/hslist` | Low
