...
21 | File | `/api/{org_id}/users` | High
22 | File | `/app/admin/controller/Upload.php` | High
23 | File | `/application/controller/Pelanggan.php` | High
24 | File | `/bin/sh` | Low
...
49 | File | `/goform/wifiSSIDset` | High
50 | ... | ... | ...
