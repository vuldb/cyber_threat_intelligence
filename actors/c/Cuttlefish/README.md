# Cuttlefish - Cyber Threat Intelligence
...
5 | File | `/admin/category.php` | High
6 | File | `/admin/edit-category.php` | High
7 | File | `/admin/edit-subcategory.php` | High
8 | File | `/admin/subcategory.php` | High
9 | File | `/admin/updateorder.php` | High
10 | File | `/aya/module/admin/ust_tab_e.inc.php` | High
11 | File | `/baseOpLog.do` | High
12 | File | `/book-appointment.php` | High
13 | File | `/category.php` | High
14 | File | `/cgi-bin/New_GUI/Igmp.asp` | High
15 | File | `/cgi-bin/portal` | High
16 | File | `/check_availability.php` | High
17 | File | `/classes/Users.php?f=save` | High
18 | File | `/controller/company/Index.php#sendCompanyLogo` | High
19 | File | `/department.php` | High
20 | File | `/forgetpassword.php` | High
21 | File | `/goform/Diagnosis` | High
22 | File | `/highlight/index.html` | High
23 | File | `/HNAP1` | Low
24 | File | `/index.php` | Medium
25 | File | `/net/core/filter.c` | High
26 | File | `/patient-report.php` | High
27 | File | `/pincode-verification.php` | High
28 | File | `/product-details.php` | High
29 | File | `/rapi/read_url` | High
30 | File | `/search-result.php` | High
31 | File | `/shopping/admin/assets/plugins/DataTables/examples/examples_support/editable_ajax.php` | High
32 | File | `/shopping/password-recovery.php` | High
33 | File | `/shopping/signup.php` | High
34 | File | `/shopping/track-orders.php` | High
35 | File | `/test/cookie/` | High
36 | File | `/tmp/foo2zjs` | Medium
37 | File | `/tmp/kamailio_fifo` | High
38 | File | `/upload` | Low
39 | File | `/Users.phpf=save` | High
40 | File | `03-00-/b` | Medium
41 | File | `add.php` | Low
42 | File | `addtocart.asp` | High
43 | File | `adherents/subscription/info.php` | High
44 | File | `admin/general` | High
45 | File | `admin/general.php` | High
46 | File | `admin/graph_trend.php` | High
47 | File | `admin/login.php` | High
48 | File | `admin/sitesettings.php` | High
49 | File | `adminler.asp` | Medium
50 | File | `adminpanel/modules/pro/inc/ajax.php` | High
51 | File | `admin\db\DoSql.php` | High
52 | File | `aide.php3` | Medium
53 | File | `ajax/ph_save.php` | High
54 | File | `ansible.cfg` | Medium
55 | ... | ... | ...
