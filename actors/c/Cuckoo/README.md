# Cuckoo - Cyber Threat Intelligence
...
4 | File | `/manager?action=getlogcat` | High
5 | File | `/oauth/idp/.well-known/openid-configuration` | High
6 | File | `/pms/update_user.php?user_id=1` | High
7 | File | `/src/assimp/code/AssetLib/LWO/LWOMaterial.cpp` | High
8 | File | `/wireless/security.asp` | High
