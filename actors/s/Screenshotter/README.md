# Screenshotter - Cyber Threat Intelligence
...
-- | ---- | --------- | ----------
1 | File | `/cgi-bin/cstecgi.cgi?action=save&setting` | High
2 | File | `/jeecg-boot/jmreport/show` | High
3 | File | `/main/webservices/additional_webservices.php` | High
4 | ... | ... | ...
