...
-- | ---- | --------- | ----------
1 | File | `/action/import_wireguard_cert_file/` | High
...
8 | File | `/api/v1/bait/set` | High
9 | File | `/app/options.py` | High
10 | File | `/book_list.php` | High
...
21 | File | `/friends` | Medium
22 | File | `/gfxpoly/stroke.c` | High
23 | File | `/goform/form2Wan.cgi` | High
24 | File | `/goform/setMacFilter` | High
25 | File | `/h/compose` | Medium
26 | File | `/index.php?module=entities/listing_types&entities_id=24` | High
27 | File | `/investigation/delete/` | High
28 | File | `/leave_system/classes/Master.php?f=delete_department` | High
29 | File | `/leave_system/classes/Users.php?f=save` | High
30 | File | `/login` | Low
31 | File | `/messageboard/view.php` | High
32 | File | `/modules/projects/vw_files.php` | High
33 | File | `/MTFWU` | Low
34 | File | `/openNDS/src/auth.c` | High
35 | File | `/opt/zimbra/jetty/webapps/zimbra/public` | High
36 | File | `/panel/fields/add` | High
37 | File | `/patient/settings.php` | High
38 | File | `/protocol/iscdevicestatus/deleteonlineuser.php` | High
39 | File | `/sbin/acos_service` | High
40 | File | `/servlet/webacc` | High
41 | File | `/src/dede/tpl.php` | High
42 | File | `/sscdms/classes/Users.php?f=save` | High
43 | File | `/textpattern/index.php` | High
44 | File | `/uploadimage` | Medium
...
48 | File | `/youthappam/php_action/editProductImage.php` | High
49 | ... | ... | ...
