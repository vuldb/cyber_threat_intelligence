...
28 | File | `/application/controller/Pengeluaran.php` | High
...
39 | File | `/dashboard/admin/submit_plan_new.php` | High
40 | File | `/doctor/appointment-bwdates-reports-details.php` | High
41 | File | `/edit-subject.php` | High
42 | File | `/endpoint/add-user.php` | High
43 | File | `/etc/controller-agent/agent.conf` | High
44 | ... | ... | ...
