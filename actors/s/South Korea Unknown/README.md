...
32 | [14.0.64.0](https://vuldb.com/?ip.14.0.64.0) | - | - | High
...
75 | [23.44.173.20](https://vuldb.com/?ip.23.44.173.20) | a23-44-173-20.deploy.static.akamaitechnologies.com | - | High
...
107 | [23.59.151.76](https://vuldb.com/?ip.23.59.151.76) | a23-59-151-76.deploy.static.akamaitechnologies.com | - | High
...
141 | [23.251.124.0](https://vuldb.com/?ip.23.251.124.0) | - | - | High
...
200 | [40.94.234.0](https://vuldb.com/?ip.40.94.234.0) | - | - | High
...
262 | [43.246.180.0](https://vuldb.com/?ip.43.246.180.0) | - | - | High
...
_Tactics, techniques, and procedures_ (TTP) summarize the suspected MITRE ATT&CK techniques used by _South Korea Unknown_. This data is unique as it uses our predictive model for actor profiling.
...
These _indicators of attack_ (IOA) list the potential fragments used for technical activities like reconnaissance, exploitation, privilege escalation, and exfiltration by South Korea Unknown. This data is unique as it uses our predictive model for actor profiling.
...
30 | File | `/admin/modules/instructor/index.php` | High
31 | File | `/admin/new-content` | High
32 | File | `/admin/posts.php?source=add_post` | High
33 | File | `/admin/products/index.php?view=add` | High
34 | File | `/admin/school_year.php` | High
35 | File | `/admin/search-appointment.php` | High
36 | File | `/admin/search1.php` | High
37 | File | `/admin/seo_setting.php` | High
38 | File | `/admin/uesrs.php&&action=delete&userid=4` | High
39 | File | `/admin/update_room.php` | High
40 | File | `/admin/user/controller.php?action=photos` | High
41 | File | `/admin/vacancy/index.php?view=edit` | High
42 | File | `/admin/view-enquiry.php` | High
43 | File | `/admin/violation_add.php?id=2` | High
44 | File | `/admin/workin-progress-requests.php` | High
45 | File | `/admin_delete.php` | High
46 | File | `/ahrw/jsp/gsfr_feditorHTML.jsp` | High
