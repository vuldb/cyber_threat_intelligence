...
12 | File | `/admin/edit_manufacturer.php` | High
...
26 | File | `/ajax.php?action=delete_tenant` | High
27 | File | `/api/controllers/merchant/shop/PosterController.php` | High
...
54 | File | `/filemanager/upload` | High
