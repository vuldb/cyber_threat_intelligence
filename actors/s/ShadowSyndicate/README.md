...
30 | File | `/admin/editempexp.php` | High
31 | File | `/admin/edit_user.php` | High
...
36 | File | `/admin/index.php/web/ajax_all_lists` | High
37 | File | `/admin/indexConfigs/save` | High
38 | File | `/admin/link.php` | High
39 | File | `/admin/login.php` | High
40 | File | `/admin/manage-category.php` | High
41 | File | `/admin/manage-nurse.php` | High
42 | File | `/admin/model/addOrUpdate` | High
43 | File | `/admin/msg.php` | High
44 | File | `/admin/network/wifi_schedule` | High
45 | File | `/admin/sales-reports-detail.php` | High
46 | File | `/admin/scripts/pi-hole/phpqueryads.php` | High
47 | File | `/admin/setup.cgi` | High
48 | File | `/admin/subcategory.php` | High
49 | File | `/admin/tag/save` | High
50 | File | `/admin/testimonials/manage.php` | High
51 | File | `/admin/view-user-queries.php` | High
52 | File | `/adminprofile.php` | High
53 | File | `/admin_topic.php?action=delall` | High
54 | File | `/adpweb/a/base/barcodeDetail/` | High
55 | File | `/adpweb/a/ica/api/service/rfa/testService` | High
