...
9 | File | `/classes/Master.php?f=delete_payment` | High
10 | File | `/com` | Low
11 | File | `/com.biepie/shared_prefs/com.bitpie_preferences.xml` | High
12 | File | `/data/nvram` | Medium
...
28 | File | `/model/update_classroom.php` | High
29 | File | `/Monitoring-History.php` | High
30 | File | `/pages/systemcall.php?command={COMMAND}` | High
31 | File | `/plugin/rundeck/webhook/` | High
32 | File | `/publisher` | Medium
...
38 | File | `/SiteServer/Ajax/ajaxOtherService.aspx` | High
