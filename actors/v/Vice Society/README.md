...
13 | File | `/admin/foreigner-bwdates-reports-details.php` | High
14 | File | `/admin/home.php?con=add` | High
...
23 | File | `/api/plugin/uninstall` | High
