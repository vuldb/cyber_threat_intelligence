...
30 | File | `/staff/tools/custom-fields` | High
31 | File | `/tmp/phpglibccheck` | High
32 | File | `/uncpath/` | Medium
33 | File | `/WebMstr7/servlet/mstrWeb` | High
34 | File | `/webpages/data` | High
...
39 | File | `/xyhai.php?s=/Auth/editUser` | High
40 | File | `/_next` | Low
