...
37 | File | `/config/config.properties` | High
38 | File | `/coreframe/app/guestbook/myissue.php` | High
39 | File | `/cupseasylive/locationcreate.php` | High
40 | File | `/dash/update.php` | High
