...
20 | File | `/devicegroups.jsp` | High
21 | File | `/download` | Medium
22 | File | `/ecrire/exec/info_plugin.php` | High
23 | File | `/Employee/edit-profile.php` | High
24 | File | `/envato/codecanyon/demo/web-file-explorer/download.php` | High
25 | File | `/forum/away.php` | High
26 | File | `/goform/execCommand` | High
27 | File | `/home/httpd/cgi-bin/cgi.cgi` | High
...
44 | File | `admin.color.php` | High
45 | File | `admin.php` | Medium
46 | File | `admin.php?mod=db&act=del` | High
47 | File | `admin.php?mod=user&act=del` | High
48 | File | `admin.php?moduleid=2&action=add` | High
49 | File | `admin/addons/archive/archive.php` | High
50 | File | `admin/auth.php` | High
51 | File | `admin/category.inc.php` | High
52 | File | `admin/conf_users_edit.php` | High
53 | File | `admin/languages.php` | High
54 | File | `admin/login.asp` | High
55 | File | `admincp/auth/checklogin.php` | High
56 | File | `admin\setting.inc.php` | High
57 | ... | ... | ...
