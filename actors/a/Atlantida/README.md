# Atlantida - Cyber Threat Intelligence
...
9 | File | `/forum1.php` | Medium
10 | File | `/inquiries/view_inquiry.php` | High
11 | File | `/ipms/imageConvert/image` | High
12 | File | `/livesite/edit_designer_region.php` | High
