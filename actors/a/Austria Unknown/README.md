...
35 | File | `/ajax.php?action=delete_payment` | High
...
40 | File | `/api/v1/devices/register` | High
...
52 | File | `/boafrm/formLtefotaUpgradeQuectel` | High
53 | File | `/boafrm/formWsc` | High
54 | File | `/booking/show_bookings/` | High
55 | File | `/cgi-bin/api.values.post` | High
56 | File | `/cgi-bin/cstecgi.cgi` | High
57 | File | `/cgi-bin/DownloadFlash` | High
58 | File | `/cgi-bin/DownloadLog` | High
59 | File | `/cgi-bin/imode_alldata.php` | High
