# UNC6240 - Cyber Threat Intelligence
...
These _indicators of attack_ (IOA) list the potential fragments used for technical activities like reconnaissance, exploitation, privilege escalation, and exfiltration by UNC6240. This data is unique as it uses our predictive model for actor profiling.
...
28 | File | `/admin/delete_s6.php` | High
29 | File | `/admin/edit-admin.php` | High
30 | File | `/admin/edit-ambulance.php` | High
31 | File | `/admin/edit-artist-detail.php?editid=1` | High
32 | File | `/admin/edit-doctor-specialization.php` | High
33 | File | `/admin/edit-services.php` | High
34 | File | `/admin/edit_student_query.php` | High
35 | File | `/admin/index.php` | High
36 | File | `/admin/link.php` | High
37 | File | `/Admin/login.php` | High
38 | File | `/admin/manage-art-medium.php` | High
39 | File | `/admin/manage-normal-ticket.php` | High
40 | File | `/admin/manage_movie.php` | High
41 | File | `/admin/member_save.php` | High
42 | File | `/admin/modules/room/index.php` | High
...
48 | File | `/admin/product.php` | High
49 | File | `/admin/products.php` | High
50 | File | `/admin/profile.php` | High
51 | File | `/admin/registered-users.php` | High
52 | File | `/admin/registration.php` | High
53 | File | `/Admin/registration.php` | High
54 | File | `/admin/return_add.php` | High
