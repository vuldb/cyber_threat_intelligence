...
12 | File | `/AttendanceMonitoring/report/index.php` | High
...
33 | File | `/index.php?action=profile;u=2;area=showalerts;do=read` | High
34 | File | `/js/player/dmplayer/dmku/?ac=edit` | High
35 | File | `/lesson/controller.php` | High
36 | ... | ... | ...
