...
-- | --------- | -------- | ----------- | ----------
1 | T1006 | CWE-21, CWE-22, CWE-23, CWE-28 | Path Traversal | High
...
23 | File | `/ajax.php?action=delete_tenant` | High
...
31 | File | `/catalog/admin/categories.php?cPath=&action=new_product` | High
