# UNC5325 - Cyber Threat Intelligence
...
3 | File | `/api/programs/orgUnits?programs` | High
4 | File | `/cgi-bin-sdb/ExportSettings.sh` | High
5 | File | `/create-ticket.php` | High
6 | File | `/index/ajax/lang` | High
7 | File | `/login.php?m=admin&c=Field&a=channel_edit` | High
8 | File | `/Profilers/PProfile/COUNT3s3.php` | High
9 | ... | ... | ...
