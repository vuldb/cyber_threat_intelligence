...
29 | File | `/admin/modules/room/index.php` | High
...
36 | File | `/admin/user-bookings.php` | High
37 | File | `/admin/user/index.php?view=edit` | High
38 | File | `/admin/yesterday-reg-users.php` | High
39 | File | `/adminapi/system/file/openfile` | High
40 | File | `/administrator/addcategory.php` | High
...
46 | File | `/app/api/v1/openvpn.py` | High
