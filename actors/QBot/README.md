...
8 | File | `/gateway/services/EdgeServiceImpl` | High
9 | File | `/goform/net\_Web\_get_value` | High
10 | File | `/goform/WriteFacMac` | High
11 | File | `/HNAP1` | Low
12 | File | `/Maintenance/configfile.cfg` | High
13 | File | `/mobilebroker/ServiceToBroker.svc/Json/Connect` | High
14 | File | `/module/comment/save` | High
15 | File | `/nagiosxi/admin/banner_message-ajaxhelper.php` | High
16 | File | `/rest` | Low
17 | File | `/root` | Low
18 | File | `/scripts/unlock_tasks.php` | High
19 | File | `/topic` | Low
20 | File | `/upload/localhost` | High
21 | ... | ... | ...
