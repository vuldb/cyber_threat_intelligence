# Gigabud - Cyber Threat Intelligence
...
13 | File | `/admin/ajax.php?action=save_menu` | High
...
17 | File | `/admin/candidates_row.php` | High
18 | File | `/admin/clientview.php` | High
19 | File | `/admin/content/index` | High
...
31 | File | `/admin/patient.php` | High
32 | File | `/admin/product/manage.php` | High
...
43 | File | `/adminpanel/admin/query/loginExe.php` | High
44 | File | `/adms/admin/?page=vehicles/sell_vehicle` | High
45 | File | `/adms/admin/?page=vehicles/view_transaction` | High
46 | File | `/adms/classes/Users.php` | High
47 | File | `/ajax` | Low
48 | File | `/ajax.php?action=read_msg` | High
49 | File | `/api/admin/system/store/order/list` | High
50 | File | `/api/client/editemedia.php` | High
51 | File | `/api/v2/open/rowsInfo` | High
52 | File | `/api/v2/open/tablesInfo` | High
53 | File | `/api/wechat/app_auth` | High
54 | File | `/app/api/controller/caiji.php` | High
55 | File | `/APR/login.php` | High
56 | File | `/author/list?limit=10&offset=0&order=desc` | High
57 | File | `/bin/ate` | Medium
58 | File | `/boat/login.php` | High
59 | File | `/bookstore/bookPerPub.php` | High
60 | File | `/cart.php` | Medium
61 | File | `/category/controller.php?action=edit` | High
62 | File | `/category/list?limit=10&offset=0&order=desc` | High
...
72 | File | `/cms/category/list` | High
73 | File | `/contact/store` | High
74 | File | `/controllers/Blocks.php` | High
