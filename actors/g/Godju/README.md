...
6 | File | `/admin.php/pic/admin/pic/hy` | High
7 | File | `/admin/?page=reports/stockin` | High
8 | File | `/admin/?page=state` | High
...
13 | File | `/admin/dashboard/profile` | High
14 | File | `/admin/edit-doctor.php` | High
15 | File | `/admin/inbox.php&action=read` | High
16 | File | `/admin/newsletter.php` | High
17 | File | `/admin/operations/packages.php` | High
18 | File | `/admin/orders/update_status.php` | High
19 | File | `/admin/overtime_add.php` | High
20 | File | `/admin/pages/sections_save.php` | High
21 | File | `/admin/rooms.php` | High
22 | File | `/admin/settings/save.php` | High
