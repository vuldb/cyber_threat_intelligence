# Outrider Tiger - Cyber Threat Intelligence
...
2 | File | `/admin/manage-tickets.php` | High
3 | File | `/Admin/student.php` | High
4 | File | `/apply/index.php` | High
5 | File | `/BBfile/Blood/o+.php` | High
6 | File | `/boafrm/formWlEncrypt` | High
7 | File | `/categoriesServlet` | High
