...
-- | ---------- | -------- | -------- | ----------
1 | 45.91.225.139 | - | - | High
2 | 45.121.146.88 | 4master-cablestd.tartshow.com | - | High
3 | 107.148.165.151 | mx151.blevary.com | - | High

## TTP - Tactics, Techniques, Procedures

_Tactics, techniques, and procedures_ (TTP) summarize the suspected ATT&CK techniques used by SharpPanda. This data is unique as it uses our predictive model for actor profiling.
