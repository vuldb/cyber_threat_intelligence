...
30 | File | `/etc/networkd-dispatcher` | High
31 | File | `/event/admin/?page=user/list` | High
32 | File | `/filemanager/upload/drop` | High
33 | File | `/food/admin/all_users.php` | High
...
40 | File | `/goform/wizard_end` | High
41 | File | `/home/get_tasks_list` | High
...
52 | File | `/ofrs/admin/?page=teams/view_team` | High
