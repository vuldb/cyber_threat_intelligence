...
56 | File | `/application/controllers/Marks.php` | High
57 | File | `/application/index/controller/Unity.php` | High
58 | File | `/attribute/queryAll` | High
59 | File | `/authentication/` | High
60 | File | `/bin/httpd` | Medium
61 | File | `/boafrm/formDebugDiagnosticRun` | High
62 | File | `/boafrm/formVpnConfigSetup` | High
63 | File | `/booking.php` | Medium
