# xorbot - Cyber Threat Intelligence
...
6 | File | `/equipment/get_Information` | High
7 | File | `/expedit.php` | Medium
8 | File | `/friendprofile.php` | High
9 | File | `/goform/AdvSetLanip` | High
10 | ... | ... | ...
