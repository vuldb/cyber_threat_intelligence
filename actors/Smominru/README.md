# Smominru - Cyber Threat Intelligence

These _indicators_ were collected during the [VulDB CTI analysis](https://vuldb.com/?kb.cti) of the actor known as [Smominru](https://vuldb.com/?actor.smominru). The _activity monitoring_ correlates data from social media, forums, chat rooms, and darknet markets. It helps to determine associated actors, specific activities, expected intentions, emerging research, and ongoing attacks. Our unique _predictive model_ is able to forecast activities and their characteristics.
...
-- | ---------- | -------- | -------- | ----------
1 | 23.88.160.137 | - | - | High
2 | 35.182.171.137 | ec2-35-182-171-137.ca-central-1.compute.amazonaws.com | - | Medium
3 | 45.58.135.106 | - | - | High
4 | 54.255.141.50 | ec2-54-255-141-50.ap-southeast-1.compute.amazonaws.com | - | Medium
5 | 66.117.6.174 | menu-btob.etherraw.com | - | High
6 | ... | ... | ... | ...
...
_Tactics, techniques, and procedures_ (TTP) summarize the suspected ATT&CK techniques used by Smominru. This data is unique as it uses our predictive model for actor profiling.
