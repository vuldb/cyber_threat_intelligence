...
These countries are directly (e.g. origin of attacks) or indirectly (e.g. access by proxy) associated with Leviathan:
...
These indicators of compromise indicate associated network ressources which are known to be part of research and attack activities of Leviathan.
...
Tactics, techniques, and procedures summarize the suspected ATT&CK techniques used by Leviathan. This data is unique as it uses our predictive model for actor profiling.
...
These indicators of attack list the potential fragments used for technical activities like reconnaissance, exploitation, privilege escalation, and exfiltration by Leviathan. This data is unique as it uses our predictive model for actor profiling.
