...
-- | --------- | -------- | ----------- | ----------
1 | T1006 | CWE-21, CWE-22, CWE-23, CWE-24, CWE-29, CWE-36, CWE-44 | Path Traversal | High
...
5 | File | `/admin/all-request.php` | High
6 | File | `/admin/app/profile_crud.php` | High
7 | File | `/admin/app/soulwinning_crud.php` | High
...
15 | File | `/admin/delete_members.php` | High
16 | File | `/Admin/detail.php` | High
17 | File | `/admin/eligibility.php` | High
...
26 | File | `/admin/salary_slip.php` | High
27 | File | `/admin/services.php` | High
...
47 | File | `/cgi-bin/ExportSyslog.sh` | High
