...
_Tactics, techniques, and procedures_ (TTP) summarize the suspected ATT&CK techniques used within PoshC2. This data is unique as it uses our predictive model for actor profiling.
