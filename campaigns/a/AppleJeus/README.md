...
20 | File | `/admin/ajax_product.php` | High
...
29 | File | `/Admin/consulting_detail.php` | High
...
72 | File | `/api/runscript` | High
73 | File | `/api/snapshots/` | High
74 | File | `/api/sys/ng-alain/getDictItemsByTable/` | High
...
92 | File | `/classes/Master.php?f=delete_record` | High
93 | ... | ... | ...
