...
4 | File | `/admin/div_data/data` | High
...
15 | File | `/admin/request-received-bydonar.php` | High
...
28 | File | `/catalog/admin/categories.php?cPath=&action=new_product` | High
...
34 | File | `/classes/Master.php?f=log_employee` | High
...
46 | File | `/goform/AdvSetLanip` | High
47 | File | `/goform/formDefault` | High
48 | File | `/goform/setDeviceSettings` | High
