...
5 | File | `/action=myprojects&logout=1` | High
...
61 | File | `/admin/workin-progress-requests.php` | High
62 | File | `/ajax/getBasicInfo.php` | High
63 | File | `/ajax_state.php` | High
64 | File | `/ajx.php` | Medium
65 | File | `/analysisProject/pagingQueryData` | High
66 | File | `/api.php` | Medium
67 | File | `/api/collection/findone` | High
68 | File | `/api/config/list` | High
69 | File | `/api/mjkj-chat/chat/ai/delete/chat` | High
70 | File | `/api/objects/recipes` | High
71 | File | `/api/upload` | Medium
72 | File | `/app/ConfirmSmsCode` | High
73 | File | `/applyleave.php` | High
74 | File | `/APR/login.php` | High
75 | File | `/assets/editNotes.php` | High
76 | File | `/auth/login` | Medium
77 | File | `/b2c/package-information` | High
78 | File | `/bank/statements.php` | High
79 | File | `/bank/transfer.php` | High
80 | File | `/billaction.php` | High
81 | File | `/bin/boa` | Medium
82 | File | `/Blood/A+.php` | High
83 | File | `/boafrm/formDosCfg` | High
84 | File | `/boafrm/formFilter` | High
85 | File | `/boafrm/formIPv6Addr` | High
86 | File | `/boafrm/formParentControl` | High
87 | File | `/boafrm/formPortFw` | High
88 | File | `/boafrm/formSysLog` | High
89 | File | `/boafrm/formWsc` | High
90 | File | `/cfgFile/downloadSoftware` | High
