...
31 | File | `/admin/role/list` | High
32 | File | `/admin/sys/admin.html` | High
...
38 | File | `/api.php` | Medium
39 | File | `/api/controllers/admin/app/AppController.php` | High
...
74 | File | `/crm/data/pdf.php` | High
75 | File | `/cussignup.php` | High
76 | File | `/devinfo` | Medium
77 | ... | ... | ...
