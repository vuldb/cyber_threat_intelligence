...
15 | File | `/admin/attendance_action.php` | High
...
23 | File | `/admin/div_data/delete?divId=9` | High
...
47 | File | `/adminapi/system/file/openfile` | High
48 | File | `/administrator/addcategory.php` | High
...
77 | File | `/cgi-bin/apkg_mgr.cgi` | High
78 | ... | ... | ...
