...
18 | File | `/admin/pages/sections_save.php` | High
...
28 | File | `/asms/admin/products/manage_product.php` | High
...
48 | File | `/confirm` | Medium
49 | File | `/depotHead/list` | High
...
58 | File | `/garage/editorder.php` | High
59 | File | `/goform/addressNat` | High
60 | File | `/goform/AdvSetWrlsafeset` | High
61 | ... | ... | ...
