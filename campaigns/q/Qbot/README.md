...
15 | File | `/goform/execCommand` | High
16 | File | `/goform/SetRebootTimer` | High
17 | File | `/goform/SetSysTimeCfg` | High
18 | File | `/goform/WriteFacMac` | High
19 | File | `/lam/tmp/` | Medium
20 | File | `/mobilebroker/ServiceToBroker.svc/Json/Connect` | High
