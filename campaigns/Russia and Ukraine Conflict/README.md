...
31 | File | `/includes/db_connect.php` | High
32 | File | `/includes/session.php` | High
...
42 | File | `/osms/assets/plugins/jquery-validation-1.11.1/demo/captcha/index.php` | High
