...
36 | File | `/goform/AdvSetLanip` | High
37 | File | `/goform/formDefault` | High
38 | File | `/goform/setDeviceSettings` | High
39 | File | `/goform/set_LimitClient_cfg` | High
40 | File | `/htdocs/cgibin` | High
41 | File | `/include/file.php` | High
42 | File | `/index.php` | Medium
43 | File | `/index.php/client/message/message_read/xxxxxxxx[random-msg-hash]` | High
