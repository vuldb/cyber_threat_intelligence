...
2 | File | `/api/sys/login` | High
3 | File | `/api/sys/set_passwd` | High
4 | File | `/api/v1` | Low
5 | File | `/bcms/admin/?page=user/manage_user` | High
6 | File | `/catalog/all-products` | High
7 | File | `/core/config-revisions` | High
8 | File | `/dataSet/testTransform;swagger-ui` | High
...
21 | File | `/newvehicle.php` | High
22 | File | `/new_item` | Medium
23 | File | `/php/ping.php` | High
24 | File | `/register.php` | High
25 | File | `/registrar/?page=registration` | High
26 | File | `/run/icinga2/cmd` | High
