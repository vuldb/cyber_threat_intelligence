# Scarcruft - Cyber Threat Intelligence
...
_Tactics, techniques, and procedures_ (TTP) summarize the suspected MITRE ATT&CK techniques used within Scarcruft. This data is unique as it uses our predictive model for actor profiling.
...
These _indicators of attack_ (IOA) list the potential fragments used for technical activities like reconnaissance, exploitation, privilege escalation, and exfiltration during Scarcruft. This data is unique as it uses our predictive model for actor profiling.
