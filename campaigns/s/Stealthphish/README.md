# Stealthphish - Cyber Threat Intelligence
...
11 | File | `bl-kernel/ajax/upload-images.php` | High
12 | File | `BlogEngine/BlogEngine.Core/Services/Security/Security.cs` | High
13 | ... | ... | ...
