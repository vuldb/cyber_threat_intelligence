...
11 | File | `/admin/assets/plugins/DataTables/media/unit_testing/templates/empty_table.php` | High
...
18 | File | `/admin/edit-products.php` | High
19 | File | `/admin/enrollment-details.php` | High
20 | File | `/admin/getallarticleinfo` | High
21 | File | `/Admin/Http/Controllers/FileManagerController.php` | High
...
28 | File | `/admin/salary_slip.php` | High
