...
19 | File | `/admin/admin_login.php` | High
...
53 | File | `/admin/index.php?r=friendly-link%2Fupdate` | High
54 | File | `/admin/inquiries/view_details.php` | High
55 | File | `/admin/ipAddPost.php` | High
...
75 | File | `/admin/siteconfig.php` | High
...
90 | File | `/Administrator/PHP/AdminAddUser.php` | High
91 | File | `/Administrator/PHP/AdminUpdateUser.php` | High
...
102 | File | `/api/v1/serve/awel/flow/import` | High
