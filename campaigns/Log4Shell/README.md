...
17 | File | `/admin/configurations/userInfo` | High
...
24 | File | `/admin/list_resource_icon.php?action=delete` | High
...
51 | File | `/apps/system/api/user.go` | High
