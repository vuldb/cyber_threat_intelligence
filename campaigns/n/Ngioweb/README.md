...
13 | [37.59.213.49](https://vuldb.com/?ip.37.59.213.49) | ip49.ip-37-59-213.eu | [Ngioweb](https://vuldb.com/?actor.ngioweb) | High
...
_Tactics, techniques, and procedures_ (TTP) summarize the suspected MITRE ATT&CK techniques used within Ngioweb. This data is unique as it uses our predictive model for actor profiling.
...
These _indicators of attack_ (IOA) list the potential fragments used for technical activities like reconnaissance, exploitation, privilege escalation, and exfiltration during Ngioweb. This data is unique as it uses our predictive model for actor profiling.
...
25 | File | `/admin/add_title.php` | High
...
29 | File | `/admin/all-request.php` | High
30 | File | `/admin/applicants/controller.php` | High
31 | File | `/admin/article/add/do` | High
