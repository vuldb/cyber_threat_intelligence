...
43 | File | `/com/esafenet/servlet/system/ProtocolService.java` | High
44 | File | `/control/edit_client.php` | High
45 | File | `/csms/classes/Master.php?f=delete_message` | High
46 | ... | ... | ...
