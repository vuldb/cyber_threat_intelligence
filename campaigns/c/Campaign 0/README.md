...
65 | File | `/admin/product.php` | High
66 | File | `/admin/profile.php` | High
67 | File | `/admin/project/update/2` | High
68 | File | `/admin/rules.php` | High
69 | File | `/admin/sales/view_details.php` | High
70 | File | `/admin/save_airlines.php` | High
71 | File | `/admin/save_student.php` | High
72 | File | `/admin/school_year.php` | High
73 | File | `/admin/search-directory.php` | High
74 | File | `/admin/search.php` | High
75 | File | `/admin/serverinfo` | High
76 | File | `/admin/sms_setting.php` | High
77 | File | `/admin/sys/admin.html` | High
78 | File | `/admin/tag/list` | High
79 | File | `/admin/template/update` | High
80 | File | `/admin/twitter.php` | High
81 | File | `/admin/update-progress.php` | High
82 | File | `/admin/updateabout.php` | High
83 | File | `/admin/user/manage_user.php` | High
84 | File | `/admin/view-patient.php` | High
85 | File | `/admin/view_all_posts.php` | High
86 | File | `/adminapi/export/product_list` | High
87 | File | `/admin_class.php` | High
88 | File | `/adposition/queryAll` | High
89 | File | `/ajax.php` | Medium
90 | File | `/ajax.php?action=delete_sales` | High
91 | File | `/api/admin/system/store/order/list` | High
92 | File | `/api/upload` | Medium
93 | File | `/api/user` | Medium
94 | File | `/api/wizard/getNetworkConf` | High
95 | File | `/app/ajax/sell_return_data.php` | High
96 | File | `/applyleave.php` | High
97 | File | `/backend/api/buscarTipoDenuncia.php` | High
