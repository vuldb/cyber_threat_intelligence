# Karagany - Cyber Threat Intelligence
...
_Tactics, techniques, and procedures_ (TTP) summarize the suspected ATT&CK techniques used within Karagany. This data is unique as it uses our predictive model for actor profiling.
