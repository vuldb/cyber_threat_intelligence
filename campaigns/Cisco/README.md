...
29 | File | `/core/admin/copyfrom.php` | High
...
39 | File | `/goform/fromqossetting` | High
40 | File | `/goform/SetFirewallCfg` | High
41 | File | `/goform/setsambacfg` | High
42 | File | `/HNAP1` | Low
