...
44 | File | `/classes/Master.php?f=save_brand` | High
...
49 | File | `/conf/` | Low
50 | File | `/config-manager/save` | High
51 | File | `/config/php.ini` | High
52 | File | `/content/templates/` | High
53 | File | `/course/filterRecords/` | High
54 | File | `/ecommerce/admin/settings/setDiscount.php` | High
55 | File | `/fusion/portal/action/Link` | High
56 | File | `/goform/Diagnosis` | High
57 | ... | ... | ...
