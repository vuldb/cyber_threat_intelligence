...
19 | File | `/app/api/controller/default/File.php` | High
20 | File | `/application/index/controller/Datament.php` | High
...
34 | File | `/cgi/cpaddons_report.pl` | High
35 | File | `/check_availability.php` | High
36 | File | `/common/dict/list` | High
...
42 | File | `/endpoint/update-tracker.php` | High
43 | File | `/forum/away.php` | High
44 | File | `/general/email/outbox/delete.php` | High
45 | File | `/goform/DhcpListClient` | High
46 | File | `/goform/goform_get_cmd_process` | High
47 | File | `/HNAP1/` | Low
48 | File | `/hrm/leaverequest.php` | High
49 | File | `/importexport.php` | High
50 | File | `/install/` | Medium
51 | File | `/Interface/DevManage/VM.php` | High
52 | File | `/libsystem/login.php` | High
53 | File | `/main/checkout.php` | High
54 | File | `/main/doctype.php` | High
55 | ... | ... | ...
