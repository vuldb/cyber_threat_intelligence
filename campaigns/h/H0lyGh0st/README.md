...
102 | File | `/ajax.php` | Medium
103 | File | `/ajax.php?action=delete_borrower` | High
104 | File | `/ajax.php?action=save_category` | High
105 | File | `/ajax.php?action=save_deductions` | High
106 | File | `/ajax.php?action=save_supplier` | High
107 | File | `/ajax.php?Ajax=GetModal_MQTTEdit` | High
108 | File | `/ajax_state.php` | High
109 | File | `/animalsupdate.php` | High
110 | File | `/api/client/editemedia.php` | High
...
116 | File | `/api/wizard/getBasicInfo` | High
117 | File | `/api/wizard/getDualbandSync` | High
118 | File | `/app/admin/controller/Images.php` | High
119 | ... | ... | ...
