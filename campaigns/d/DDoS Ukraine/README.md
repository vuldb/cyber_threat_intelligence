...
12 | File | `/dev/audio` | Medium
13 | File | `/dl/dl_print.php` | High
14 | File | `/etc/crash` | Medium
...
25 | File | `/labvantage/rc?command=page&page=SampleHistoricalList&_iframename=list&__crc=crc_1701669816260` | High
...
32 | File | `/src/njs/src/njs_module.c` | High
33 | File | `/userui/ticket_list.php` | High
34 | File | `/usr/5bin/su` | Medium
35 | File | `/vloggers_merch/classes/Master.php?f=delete_category` | High
36 | File | `/wp-admin/options-general.php` | High
37 | File | `/zm/index.php` | High
38 | File | `1.x/src/rogatkin/web/WarRoller.java` | High
39 | File | `abook_database.php` | High
40 | File | `accounts/inc/include.php` | High
41 | File | `ActivityOptions.java` | High
42 | File | `adaptive-images-script.php` | High
...
50 | File | `admin/article_save.php` | High
51 | File | `admin/general.php` | High
52 | File | `admin/header.php` | High
...
64 | File | `annonces-p-f.php` | High
65 | File | `announce.php` | Medium
66 | File | `announcement.php` | High
67 | File | `announcements.php` | High
68 | File | `app/admin/routing/edit-bgp-mapping-search.php` | High
69 | File | `app/models/user.rb` | High
70 | File | `application/config/config.php` | High
71 | File | `application/controllers/basedata/inventory.php` | High
