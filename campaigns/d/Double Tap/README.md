...
118 | File | `/api/videos/public` | High
119 | File | `/api/wizard/getCapabilityWeb` | High
120 | ... | ... | ...

There are 1062 more IOA items available (file, library, argument, input value, pattern, network port). Please use our online service to access the data.
