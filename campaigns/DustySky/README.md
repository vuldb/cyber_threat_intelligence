...
_Tactics, techniques, and procedures_ (TTP) summarize the suspected MITRE ATT&CK techniques used within DustySky. This data is unique as it uses our predictive model for actor profiling.
...
2 | File | `/collection/all` | High
3 | File | `/config/php.ini` | High
4 | File | `/search.php` | Medium
5 | ... | ... | ...
