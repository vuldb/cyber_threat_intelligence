...
27 | File | `/tmp/s48lose.tmp` | High
28 | File | `/tmp/xbindkeysrc-tmp` | High
29 | File | `/uncpath/` | Medium
30 | File | `/usr/local` | Medium
31 | File | `/var/log/nginx` | High
32 | File | `/var/run/jboss-eap/` | High
33 | File | `admin-ajax.php` | High
34 | File | `admin.jcomments.php` | High
35 | File | `admin.php` | Medium
36 | File | `admin/?n=language&c=language_general&a=doSearchParameter` | High
37 | File | `admin/?n=user&c=admin_user&a=doGetUserInfo` | High
38 | ... | ... | ...
