...
27 | File | `/admin/offenses/view_details.php` | High
...
32 | File | `/admin/read.php?mudi=getSignal` | High
...
49 | File | `/ajax/myshop` | Medium
50 | File | `/alarm_pi/alarmService.php` | High
51 | File | `/api/gen/clients/{language}` | High
