...
39 | File | `/public_html/users.php` | High
...
46 | File | `/usr/local/WowzaStreamingEngine/bin/` | High
47 | File | `/WEB-INF/web.xml` | High
48 | File | `/wireless/guestnetwork.asp` | High
49 | File | `?r=recruit/interview/export&interviews=x` | High
50 | File | `a2dp_aac_decoder.cc` | High
51 | File | `actbar3.ocx` | Medium
